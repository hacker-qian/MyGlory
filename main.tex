...
\label{fig_sim}
\end{figure*}
\subsection{Runtime Access Analyzer}
...
\hline
VNA table &
\tabincell{l}{VNA[n][p] records the number of\\ memory access from node n to each \\page p of the VM.} \\
\hline
VMD table &
